...
class Trainer(object):
    ...
    def __init__(self, args):
        ...
        # 这里trainval_dataset对应的是.yaml文件中的data下的属性，为PartialCompDataset
        # 这行命令等价于trainval_class = datasets.PartialCompDataset
        # 就是说这个class指向了定义好的PartialCompDataset类
        ...
        if not args.validate:  # train
            ...
            # 将 train_dataset 设置为一个 PartialCompDataset 实例，该实例的 config 属性是 args.data，phase 属性是 'train'
